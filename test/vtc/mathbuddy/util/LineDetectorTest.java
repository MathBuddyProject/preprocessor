...
import vtc.mathbuddy.util.LineDetector.HoughAlgorithmResult;

public class LineDetectorTest extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		HoughAlgorithmResult result = LineDetector.houghAlgorithm(gradient, width - 2, height - 2, THETA_COUNT, filter);
